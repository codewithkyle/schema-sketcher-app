import s from"./supercomponent.js";import{render as a,html as l}from"./lit-html.js";import c from"./settings-modal.js";import{css as d,mount as m}from"./env.js";import n from"./diagram-controller.js";import{disconnect as p}from"./ws.js";import{subscribe as h}from"./pubsub.js";import{setValueFromKeypath as u,unsetValueFromKeypath as v}from"./sync.js";import{navigateTo as w}from"./router.js";import r from"./session-controller.js";class i extends s{constructor(t){super();this.handleBlur=t=>{t.preventDefault(),t.stopImmediatePropagation();let o=t.currentTarget.value.trim();o.length||(o="UNTITLED"),n.renameDiagram(o),this.update({name:o})};this.openSettingsModal=t=>{const e=new c;document.body.appendChild(e)};this.openCollabModal=async t=>{r.room?prompt("Collaboration URL",r.getURL()):r.create()};this.back=t=>{t.preventDefault(),t.stopImmediatePropagation(),p(),w("/")};this.model={name:t},d(["editor-header","buttons"]).then(()=>{this.render()}),h("sync",this.syncInbox.bind(this))}syncInbox(t){if(t.table==="diagrams"&&t.diagramID===n.ID){const e={...this.model};switch(t.op){case"UNSET":v(e,t.keypath),this.update(e);break;case"SET":u(e,t.keypath,t.value),this.update(e);break;default:break}}}render(){const t=l`
        ...
        `;a(t,this)}}m("editor-header",i);export{i as default};
