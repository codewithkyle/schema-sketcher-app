import m from"./supercomponent.js";import{render as f,html as o}from"./lit-html.js";import u from"./env.js";import l from"./modals.js";import a from"./diagram-controller.js";import c from"./save-file.js";import"./input.js";import g from"./open-file.js";import r from"./alerts.js";import{subscribe as k}from"./pubsub.js";import b from"./settings-modal.js";import M from"./help-modal.js";class w extends m{constructor(){super();this.toggle=e=>{this.set({open:!this.model.open})};this.onReset=e=>{l.dangerous({title:"Reset the canvas?",message:"This will remove all of your work and cannot be undone.",confirm:"Reset",cancel:"Cancel",callbacks:{confirm:()=>{a.reset()}}})};this.onSave=e=>{this.save()};this.onOpen=e=>{if(window?.showOpenFilePicker)g({description:"Schema Sketcher Diagram",mimeTypes:["application/json"],extensions:[".json"]}).then(t=>{const s=new FileReader;s.onload=n=>{const i=n.target.result;a.import(i),r.toast("File opened")},s.readAsText(t)});else{const t=document.createElement("input");t.type="file",t.accept=".json",t.onchange=s=>{const n=t.files[0],i=new FileReader;i.onload=d=>{const p=d.target.result;a.import(p),r.toast("File opened")},i.readAsText(n)},t.click()}};this.onSettings=e=>{l.raw({view:o`${new b}`,closeable:!0})};this.onHelp=e=>{l.raw({view:o`${new M}`,width:769,closeable:!0})};this.onInstall=e=>{this.deferredInstallPrompt?(this.deferredInstallPrompt.prompt(),this.deferredInstallPrompt.userChoice.then(()=>{this.deferredInstallPrompt=null})):r.snackbar("Your browser does not support installation of web applications.")};this.file=null,this.deferredInstallPrompt=null,this.model={open:!1,unsaved:!1},k("diagram",this.diagramInbox.bind(this))}async connected(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),this.deferredInstallPrompt=e}),await u.css(["main-menu","button","modals"]).then(()=>{this.render()}),window.addEventListener("beforeunload",e=>{if(this.model.unsaved){var t="Are you sure you want to exit? You have unsaved changes.";return(e||window.event).returnValue=t,t}})}diagramInbox({type:e,data:t}){switch(e){case"dirty":this.set({unsaved:!0});break;case"load":this.file=null,this.set({unsaved:!1});break;case"reset":this.file=null,this.set({unsaved:!1});break;default:break}}async save(){const[e,t]=a.export(),s=e.fileName||"untitled";this.file!==null?(this.file=await c(new Blob([t],{type:"application/json"}),{fileName:`${e.fileName}.json`,mimeTypes:["application/json"],extensions:[".json"],id:e.uid.replace(/-/g,"")},this.file),r.toast("File saved"),this.set({unsaved:!1})):l.form({title:"Save diagram",view:o`
                    <brixi-input
                        data-value="${s}"
                        data-name="fileName"
                        data-required="true"
                    ></brixi-input>
                `,submit:"Save",callbacks:{submit:async(n,i,d)=>{if(a.setFileName(n.fileName),window?.showSaveFilePicker)this.file=await c(new Blob([t],{type:"application/json"}),{fileName:`${n.fileName}.json`,mimeTypes:["application/json"],extensions:[".json"],id:e.uid.replace(/-/g,"")},this.file);else{const p=new Blob([t],{type:"application/json"}),v=URL.createObjectURL(p),h=document.createElement("a");h.href=v,h.download=`${n.fileName}.json`,h.click(),URL.revokeObjectURL(v)}d.remove(),r.toast("File saved"),this.set({unsaved:!1})}}})}renderMenuButton(){return this.model.open?o`
        ...
        `;f(e,this)}}u.bind("main-menu",w);export{w as default};
